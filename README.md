...
| Projects | Computer Lab Management Web Platform — A web platform designed to help teachers check and manage the availability of computer labs at a university. Quinceañera Registration Website — A website created to register and manage guests for a quinceañera celebration using HTML, CSS, and JavaScript. 
